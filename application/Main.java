...
public class Main extends Application {
	...
	public static int XMAX = SIZE * 12; // X Axis 300px
	public static int YMAX = SIZE * 24;  // Y Axis 600px
	public static int[][] MESH = new int[XMAX / SIZE][YMAX / SIZE]; // Dimension of Area  [12][24]
	private static Pane group = new Pane();
	private static Form object;  // Form class Object
	private static Scene scene = new Scene(group, XMAX + 150, YMAX);  // 450px X-axis(Whole Area)  
	public static int score = 0;  // score 
//  Used on top timer
	private static int top = 0;  
	private static boolean game = true;
	private static Form nextObj = Controller.makeRect();  // This will return Random Rectangles
	private static int linesNo = 0; // in start line 0
	...
	public void start(Stage stage) throws Exception {
		for (int[] a : MESH) {
			Arrays.fill(a, 0);  // filling array with 0 
		}
...
// StartX StartY EndX EndY
		...
		level.setY(100);
		level.setX(XMAX + 5);    // same setting for level
		level.setFill(Color.GREEN);
		
//		 Adding score line and  level  into pane
		group.getChildren().addAll(scoretext, line, level);

		Form a = nextObj;  // assigning random rectangles to variable a
...
//					System.out.println("lines"+lines.get(0));
					if (a.getY() == lines.get(0) * SIZE) {
						// As all rectangles will be stored in a so making index to zero
...
//			 creating a new block and add to scene 
//			 when one whole whole block fall then add another one
			Form a = nextObj;
			nextObj = Controller.makeRect();
			object = a;
